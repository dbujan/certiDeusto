...
class XmlController {
    ...
    async signXml (req: Request,res: Response) {    
    ...
    async loginTrustOs(req: Request, res: Response){
    ...
    async insertTrustOS(req: Request, res:Response){
        ...
        try {
            ...
            const credentials = await pool.promise().query('INSERT INTO credential set ?', [object]);
        ...
        async getFromTrustOS(req: Request, res:Response){
    ...
    async pruebaPy (req: Request,res: Response) {
        const {spawn} = require('node:child_process');
